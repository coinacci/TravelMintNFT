...
export async function registerRoutes(app: Express) {
  ...
  app.get("/.well-known/farcaster.json", (req, res) => {
    ...
    const manifest = {
      // Note: accountAssociation will need to be generated by user with their Farcaster account
      "accountAssociation": {
        "header": "TO_BE_GENERATED", // User needs to generate this
        "payload": "TO_BE_GENERATED", // User needs to generate this  
        "signature": "TO_BE_GENERATED" // User needs to generate this
      },
      "miniapp": {
        "version": "1",
        "name": "TravelMint",

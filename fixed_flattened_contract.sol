...
// Fixed flattened TravelNFT contract for Basescan verification
...
contract TravelNFT is ERC721, Ownable, ReentrancyGuard {
    ...
    function updateMintPrice(uint256 /* newPrice */) external view onlyOwner {
